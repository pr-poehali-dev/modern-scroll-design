...
const About = () => {
  return (
    <section id="about" className="py-20 bg-medical-lightBlue">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-medical-darkBlue mb-6">
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 medical-gradient rounded-full flex items-center justify-center flex-shrink-0">
